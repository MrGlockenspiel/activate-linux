...
// English is default language, so it has to be first in the list
  ...
  {"ko_KR", {"", " 정품 인증", "[설정]으로 이동하여 ", " 를 정품 인증합니다."},
    {"", "", ""}},
  {"bg_BG", {"Активирайте ", "", "Отидете в Настройките, за да активирате ", "."},
    {"Няма нужда да активирате ", "", "Ние не сме толкова досадни, колкото Microsoft."}},
